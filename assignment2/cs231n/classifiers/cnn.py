...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        D = int(num_filters * input_dim[1]**2 / 4)
    ...
    def loss(self, X, y=None):
        ...
        last_grad, grads['W3'], grads['b3'] = affine_backward(dloss, cache3)
        grads['W3'] += self.reg * W3
        last_grad, grads['W2'], grads['b2'] = affine_relu_backward(last_grad, cache2)
        grads['W2'] += self.reg * W2
        last_grad, grads['W1'], grads['b1'] = conv_relu_pool_backward(last_grad, cache1)
